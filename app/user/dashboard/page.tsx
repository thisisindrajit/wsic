        ...
        <>
            <div className="max-w-6xl m-auto pb-24 md:pb-0">
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-12 gap-4 md:gap-6">
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-4 md:gap-6 px-4 lg:px-0">
                        ...
                        {/* Mobile-only subscription and trending content */}
                    ...
                    <div className="hidden md:block lg:col-span-4 lg:h-[calc(100dvh-7rem)] lg:sticky lg:top-4 lg:overflow-auto px-4 mt-3 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
