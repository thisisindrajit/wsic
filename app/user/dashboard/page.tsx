    ...
    return (
        <div className="max-w-6xl m-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-3 h-[calc(100dvh-7rem)] sticky top-4 mt-3">
                    <NavigationSidebar />
                </div>
                ...
                <div className="lg:col-span-4 h-[calc(100dvh-7rem)] sticky top-4 overflow-auto px-4 flex flex-col gap-4 mt-3 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                    <SubscriptionCard />
                    <TrendingTopics />
                </div>
            </div>
